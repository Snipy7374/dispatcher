...
from typing import Any, Dict, List, Literal, NamedTuple, Optional, TYPE_CHECKING, Tuple, Type, Union, overload
from .. import utils
...
class AsyncDeferredLock:
    ...
    async def __aenter__(self): # -> Self@AsyncDeferredLock:
        ...
...
class AsyncWebhookAdapter:
    ...
    async def request(self, route: Route, session: aiohttp.ClientSession, *, payload: Optional[Dict[str, Any]] = ..., multipart: Optional[List[Dict[str, Any]]] = ..., files: Optional[List[File]] = ..., reason: Optional[str] = ..., auth_token: Optional[str] = ..., params: Optional[Dict[str, Any]] = ...) -> Any:
        ...
    ...
    def execute_webhook(self, webhook_id: int, token: str, *, session: aiohttp.ClientSession, payload: Optional[Dict[str, Any]] = ..., multipart: Optional[List[Dict[str, Any]]] = ..., files: Optional[List[File]] = ..., thread_id: Optional[int] = ..., wait: bool = ...) -> Response[Optional[MessagePayload]]:
        ...
    
    def get_webhook_message(self, webhook_id: int, token: str, message_id: int, *, session: aiohttp.ClientSession) -> Response[MessagePayload]:
        ...
    
    def edit_webhook_message(self, webhook_id: int, token: str, message_id: int, *, session: aiohttp.ClientSession, payload: Optional[Dict[str, Any]] = ..., multipart: Optional[List[Dict[str, Any]]] = ..., files: Optional[List[File]] = ...) -> Response[Message]:
        ...
    
    def delete_webhook_message(self, webhook_id: int, token: str, message_id: int, *, session: aiohttp.ClientSession) -> Response[None]:
        ...
    ...
    def create_interaction_response(self, interaction_id: int, token: str, *, session: aiohttp.ClientSession, type: int, data: Optional[Dict[str, Any]] = ..., files: Optional[List[File]] = ...) -> Response[None]:
        ...
    ...
    def edit_original_interaction_response(self, application_id: int, token: str, *, session: aiohttp.ClientSession, payload: Optional[Dict[str, Any]] = ..., multipart: Optional[List[Dict[str, Any]]] = ..., files: Optional[List[File]] = ...) -> Response[MessagePayload]:
        ...
...
def handle_message_parameters(content: Optional[str] = ..., *, username: str = ..., avatar_url: Any = ..., tts: bool = ..., file: File = ..., files: List[File] = ..., attachments: List[Attachment] = ..., embed: Optional[Embed] = ..., embeds: List[Embed] = ..., view: Optional[View] = ..., allowed_mentions: Optional[AllowedMentions] = ..., previous_allowed_mentions: Optional[AllowedMentions] = ..., ephemeral: Optional[bool] = ..., flags: Optional[MessageFlags] = ..., suppress_embeds: Optional[bool] = ...) -> ExecuteWebhookParameters:
    ...
...
class _WebhookState:
    ...
    def store_user(self, data): # -> User | BaseUser:
        ...
...
class WebhookMessage(Message):
    ...
    async def edit(self, content: Optional[str] = ..., embeds: List[Embed] = ..., embed: Optional[Embed] = ..., file: File = ..., files: List[File] = ..., attachments: List[Attachment] = ..., view: Optional[View] = ..., allowed_mentions: Optional[AllowedMentions] = ..., delete_after: Optional[float] = ...) -> WebhookMessage:
        """|coro|
...
class BaseWebhook(Hashable):
    __slots__: Tuple[str, ...] = ...
    def __init__(self, data: WebhookPayload, token: Optional[str] = ..., state: Optional[ConnectionState] = ...) -> None:
        ...
...
class Webhook(BaseWebhook):
    ...
    """
    __slots__: Tuple[str, ...] = ...
    def __init__(self, data: WebhookPayload, session: aiohttp.ClientSession, token: Optional[str] = ..., state=...) -> None:
        ...
    ...
    async def edit(self, *, reason: Optional[str] = ..., name: Optional[str] = ..., avatar: Optional[Union[bytes, Asset, Attachment, File]] = ..., channel: Optional[Snowflake] = ..., prefer_auth: bool = ...) -> Webhook:
        """|coro|
    ...
    @overload
    async def send(self, content: str = ..., *, username: str = ..., avatar_url: Union[Asset, str] = ..., tts: bool = ..., file: File = ..., files: List[File] = ..., embed: Embed = ..., embeds: List[Embed] = ..., allowed_mentions: AllowedMentions = ..., view: View = ..., thread: Snowflake = ..., wait: Literal[True], delete_after: Optional[float] = ..., ephemeral: Optional[bool] = ..., flags: Optional[MessageFlags] = ..., suppress_embeds: Optional[bool] = ...) -> WebhookMessage:
        ...
    
    @overload
    async def send(self, content: str = ..., *, username: str = ..., avatar_url: Union[Asset, str] = ..., tts: bool = ..., file: File = ..., files: List[File] = ..., embed: Embed = ..., embeds: List[Embed] = ..., allowed_mentions: AllowedMentions = ..., view: View = ..., thread: Snowflake = ..., wait: Literal[False] = ..., delete_after: Optional[float] = ..., ephemeral: Optional[bool] = ..., flags: Optional[MessageFlags] = ..., suppress_embeds: Optional[bool] = ...) -> None:
        ...
    
    async def send(self, content: str = ..., *, username: str = ..., avatar_url: Union[Asset, str] = ..., tts: bool = ..., file: File = ..., files: List[File] = ..., embed: Embed = ..., embeds: List[Embed] = ..., allowed_mentions: AllowedMentions = ..., view: View = ..., thread: Snowflake = ..., wait: bool = ..., delete_after: Optional[float] = ..., ephemeral: Optional[bool] = ..., flags: Optional[MessageFlags] = ..., suppress_embeds: Optional[bool] = ...) -> Optional[WebhookMessage]:
        """|coro|
    ...
    async def edit_message(self, message_id: int, *, content: Optional[str] = ..., embeds: List[Embed] = ..., embed: Optional[Embed] = ..., file: File = ..., files: List[File] = ..., attachments: List[Attachment] = ..., view: Optional[View] = ..., allowed_mentions: Optional[AllowedMentions] = ...) -> WebhookMessage:
        """|coro|
