...
from typing import Any, Dict, List, Literal, Optional, TYPE_CHECKING, Tuple, Type, Union, overload
from .. import utils
...
class DeferredLock:
    ...
    def __enter__(self): # -> Self@DeferredLock:
        ...
...
class WebhookAdapter:
    ...
    def request(self, route: Route, session: Session, *, payload: Optional[Dict[str, Any]] = ..., multipart: Optional[List[Dict[str, Any]]] = ..., files: Optional[List[File]] = ..., reason: Optional[str] = ..., auth_token: Optional[str] = ..., params: Optional[Dict[str, Any]] = ...) -> Any:
        ...
    
    def delete_webhook(self, webhook_id: int, *, token: Optional[str] = ..., session: Session, reason: Optional[str] = ...): # -> Any:
        ...
    
    def delete_webhook_with_token(self, webhook_id: int, token: str, *, session: Session, reason: Optional[str] = ...): # -> Any:
        ...
    
    def edit_webhook(self, webhook_id: int, token: str, payload: Dict[str, Any], *, session: Session, reason: Optional[str] = ...): # -> Any:
        ...
    
    def edit_webhook_with_token(self, webhook_id: int, token: str, payload: Dict[str, Any], *, session: Session, reason: Optional[str] = ...): # -> Any:
        ...
    
    def execute_webhook(self, webhook_id: int, token: str, *, session: Session, payload: Optional[Dict[str, Any]] = ..., multipart: Optional[List[Dict[str, Any]]] = ..., files: Optional[List[File]] = ..., thread_id: Optional[int] = ..., wait: bool = ...): # -> Any:
        ...
    
    def get_webhook_message(self, webhook_id: int, token: str, message_id: int, *, session: Session): # -> Any:
        ...
    
    def edit_webhook_message(self, webhook_id: int, token: str, message_id: int, *, session: Session, payload: Optional[Dict[str, Any]] = ..., multipart: Optional[List[Dict[str, Any]]] = ..., files: Optional[List[File]] = ...): # -> Any:
        ...
    
    def delete_webhook_message(self, webhook_id: int, token: str, message_id: int, *, session: Session): # -> Any:
        ...
    
    def fetch_webhook(self, webhook_id: int, token: str, *, session: Session): # -> Any:
        ...
    
    def fetch_webhook_with_token(self, webhook_id: int, token: str, *, session: Session): # -> Any:
        ...
...
class SyncWebhookMessage(Message):
    ...
    def edit(self, content: Optional[str] = ..., embeds: List[Embed] = ..., embed: Optional[Embed] = ..., attachments: List[Attachment] = ..., file: File = ..., files: List[File] = ..., allowed_mentions: Optional[AllowedMentions] = ...) -> SyncWebhookMessage:
        """Edits the message.
...
class SyncWebhook(BaseWebhook):
    ...
    """
    __slots__: Tuple[str, ...] = ...
    def __init__(self, data: WebhookPayload, session: Session, token: Optional[str] = ..., state=...) -> None:
        ...
    ...
    def edit(self, *, reason: Optional[str] = ..., name: Optional[str] = ..., avatar: Optional[Union[bytes, File]] = ..., channel: Optional[Snowflake] = ..., prefer_auth: bool = ...) -> SyncWebhook:
        """Edits this Webhook.
    ...
    def send(self, content: str = ..., *, username: str = ..., avatar_url: Any = ..., tts: bool = ..., file: File = ..., files: List[File] = ..., embed: Embed = ..., embeds: List[Embed] = ..., allowed_mentions: AllowedMentions = ..., thread: Snowflake = ..., wait: bool = ...) -> Optional[SyncWebhookMessage]:
    ...
    def edit_message(self, message_id: int, *, content: Optional[str] = ..., embeds: List[Embed] = ..., embed: Optional[Embed] = ..., file: File = ..., files: List[File] = ..., attachments: List[Attachment] = ..., allowed_mentions: Optional[AllowedMentions] = ...) -> SyncWebhookMessage:
