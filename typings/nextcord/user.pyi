...
class BaseUser(_UserTag):
    ...
    if TYPE_CHECKING:
        ...
        _public_flags: int
        ...
    def __init__(self, *, state: ConnectionState, data: Union[PartialUserPayload, UserPayload]) -> None:
        ...
...
class ClientUser(BaseUser):
    ...
    async def edit(self, *, username: str = ..., avatar: Optional[Union[bytes, Asset, Attachment, File]] = ...) -> ClientUser:
        """|coro|
