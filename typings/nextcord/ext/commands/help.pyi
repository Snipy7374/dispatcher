...
class HelpCommand:
    ...
    MENTION_TRANSFORMS = ...
    MENTION_PATTERN = ...
    def __new__(cls, *args, **kwargs): # -> Self@HelpCommand:
        ...
    ...
    async def filter_commands(self, commands, *, sort: bool = ..., key: Optional[Callable[[Command[Any, Any, Any]], str]] = ...): # -> list[Command[Any, Any, Any]] | list[Unknown]:
        """|coro|
    ...
    def get_destination(self): # -> MessageableChannel:
...
class DefaultHelpCommand(HelpCommand):
    ...
    def get_destination(self): # -> MessageableChannel | User | Member:
        ...
