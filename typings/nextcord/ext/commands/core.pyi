...
from ._types import Check, Coro, _BaseCommand
from .cog import Cog
...
def wrap_callback(coro): # -> _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), Coroutine[Any, Any, Unknown | None]]:
    ...

def hooked_wrapped_callback(command, ctx, coro): # -> _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), Coroutine[Any, Any, Unknown | None]]:
    ...
...
class GroupMixin(Generic[CogT]):
    ...
    """
    def __init__(self, *args, case_insensitive: bool = ..., **kwargs) -> None:
        ...
    ...
    @overload
    def command(self, name: str = ..., cls: Type[Command[CogT, P, T]] = ..., *args: Any, **kwargs: Any) -> Callable[[Union[Callable[Concatenate[CogT, ContextT, P], Coro[T]], Callable[Concatenate[ContextT, P], Coro[T]],]], Command[CogT, P, T],]:
        ...
    
    @overload
    def command(self, name: str = ..., cls: Type[CommandT] = ..., *args: Any, **kwargs: Any) -> Callable[[Callable[Concatenate[Context, P], Coro[Any]]], CommandT]:
        ...
    ...
    @overload
    def group(self, name: str = ..., cls: Type[Group[CogT, P, T]] = ..., *args: Any, **kwargs: Any) -> Callable[[Union[Callable[Concatenate[CogT, ContextT, P], Coro[T]], Callable[Concatenate[ContextT, P], Coro[T]],]], Group[CogT, P, T],]:
        ...
    
    @overload
    def group(self, name: str = ..., cls: Type[GroupT] = ..., *args: Any, **kwargs: Any) -> Callable[[Callable[Concatenate[Context, P], Coro[Any]]], GroupT]:
        ...
...
@overload
def command(name: str = ..., cls: Type[Command[CogT, P, T]] = ..., **attrs: Any) -> Callable[[Union[Callable[Concatenate[CogT, ContextT, P], Coro[T]], Callable[Concatenate[ContextT, P], Coro[T]],]], Command[CogT, P, T],]:
    ...

@overload
def command(name: str = ..., cls: Type[CommandT] = ..., **attrs: Any) -> Callable[[Union[Callable[Concatenate[Cog, ContextT, P], Coro[Any]], Callable[Concatenate[ContextT, P], Coro[Any]],]], CommandT,]:
    ...

def command(name: str = ..., cls: Union[Type[CommandT], Type[Command[CogT, P, T]]] = ..., **attrs: Any) -> Callable[[Union[Callable[Concatenate[CogT, ContextT, P], Coro[Any]], Callable[Concatenate[ContextT, P], Coro[Any]],]], Union[Command[CogT, P, T], CommandT],]:
...
@overload
def group(name: str = ..., **attrs: Any) -> Callable[[Union[Callable[Concatenate[Cog, ContextT, P], Coro[T]], Callable[Concatenate[ContextT, P], Coro[T]],]], Group[Cog, P, T],]:
    ...

@overload
def group(name: str = ..., cls: Type[Group[CogT, P, T]] = ..., **attrs: Any) -> Callable[[Union[Callable[Concatenate[CogT, ContextT, P], Coro[T]], Callable[Concatenate[ContextT, P], Coro[T]],]], Group[CogT, P, T],]:
    ...

@overload
def group(name: str = ..., cls: Type[GroupT] = ..., **attrs: Any) -> Callable[[Union[Callable[Concatenate[Cog, ContextT, P], Coro[Any]], Callable[Concatenate[ContextT, P], Coro[Any]],]], GroupT,]:
    ...

def group(name: str = ..., cls: Union[Type[GroupT], Type[Group[CogT, P, T]]] = ..., **attrs: Any) -> Callable[[Union[Callable[Concatenate[CogT, ContextT, P], Coro[Any]], Callable[Concatenate[ContextT, P], Coro[Any]],]], Union[Group[CogT, P, T], GroupT],]:
