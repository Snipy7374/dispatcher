...
class FlagsMeta(type):
    if TYPE_CHECKING:
        ...
        ...
    def __new__(cls: Type[type], name: str, bases: Tuple[type, ...], attrs: Dict[str, Any], *, case_insensitive: bool = ..., delimiter: str = ..., prefix: str = ...): # -> type:
        ...
...
async def convert_flag(ctx, argument: str, flag: Flag, annotation: Any = ...) -> Any:
    ...
