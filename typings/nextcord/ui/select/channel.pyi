...
class ChannelSelect(SelectBase, Generic[V]):
    ...
    def __init__(self, *, custom_id: str = ..., placeholder: Optional[str] = ..., min_values: int = ..., max_values: int = ..., disabled: bool = ..., row: Optional[int] = ..., channel_types: List[ChannelType] = ...) -> None:
        ...
...
def channel_select(*, placeholder: Optional[str] = ..., custom_id: str = ..., min_values: int = ..., max_values: int = ..., disabled: bool = ..., row: Optional[int] = ..., channel_types: List[ChannelType] = ...) -> Callable[[ItemCallbackType[ChannelSelect[V], ClientT]], ItemCallbackType[ChannelSelect[V], ClientT]]:
